...
Namespace DXGrid_UnboundColumns_CodeBehind
	...
	'''</summary>
	<Global.System.Serializable(), Global.System.ComponentModel.DesignerCategoryAttribute("code"), Global.System.ComponentModel.ToolboxItem(True), Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedDataSetSchema"), Global.System.Xml.Serialization.XmlRootAttribute("dsProducts"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>
	Partial Public Class dsProducts
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal SupplierID As Integer, ByVal CategoryID As Integer, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal ReorderLevel As Short, ByVal Discontinued As Boolean) As ProductsRow
				...
				Dim columnValuesArray() As Object = { Nothing, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued}
		...
		Partial Public Class ProductsRow
			...
			Public Property ProductID() As Integer
				Get
					Return (CInt(Math.Truncate(Me(Me.tableProducts.ProductIDColumn))))
				End Get
			...
			Public Property SupplierID() As Integer
				Get
					Try
						Return (CInt(Math.Truncate(Me(Me.tableProducts.SupplierIDColumn))))
			...
			Public Property CategoryID() As Integer
				Get
					Try
						Return (CInt(Math.Truncate(Me(Me.tableProducts.CategoryIDColumn))))
					Catch e As Global.System.InvalidCastException
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)"
		...
		Private Sub InitConnection()
			...
			Me._connection.ConnectionString = My.Settings.Default.NORTHWNDConnectionString
		End Sub
		...
		Public Overridable Function Fill(ByVal dataTable As dsProducts.ProductsDataTable) As Integer
		...
		Public Overridable Function GetData() As dsProducts.ProductsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New dsProducts.ProductsDataTable()
		...
		Public Overridable Function Update(ByVal dataTable As dsProducts.ProductsDataTable) As Integer
			Return Me.Adapter.Update(dataTable)
		End Function

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>
		Public Overridable Function Update(ByVal dataSet As dsProducts) As Integer
		...
		Public Overridable Function Update(ByVal ProductName As String, ByVal SupplierID? As Integer, ByVal CategoryID? As Integer, ByVal QuantityPerUnit As String, ByVal UnitPrice? As Decimal, ByVal UnitsInStock? As Short, ByVal UnitsOnOrder? As Short, ByVal ReorderLevel? As Short, ByVal Discontinued As Boolean, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_SupplierID? As Integer, ByVal Original_CategoryID? As Integer, ByVal Original_QuantityPerUnit As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short, ByVal Original_UnitsOnOrder? As Short, ByVal Original_ReorderLevel? As Short, ByVal Original_Discontinued As Boolean, ByVal ProductID As Integer) As Integer
			...
			If (Original_SupplierID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(12).Value = (CInt(Original_SupplierID.Value))
			Else
			...
			If (Original_CategoryID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(14).Value = (CInt(Original_CategoryID.Value))
			Else
			...
			If (Original_UnitsInStock.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(20).Value = (CShort(Original_UnitsInStock.Value))
			Else
			...
			If (Original_UnitsOnOrder.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(22).Value = (CShort(Original_UnitsOnOrder.Value))
			Else
			...
			If (Original_ReorderLevel.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(24).Value = (CShort(Original_ReorderLevel.Value))
			Else
			...
			Me.Adapter.UpdateCommand.Parameters(26).Value = (CInt(ProductID))
